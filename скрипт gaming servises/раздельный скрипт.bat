...
cls
:start
echo 1. Удаление gaming services и SoftwareDistribution
echo 2. Проверка системы на целостность
echo 3. запуск wsreset
echo 4. Установка gaming services
...
echo 5. Ручная установка
echo 6. Автоматическая установка
set /p choice=Введите цифру 
if '%choice%'=='5' = goto 5
if '%choice%'=='6' = goto 6
goto start
